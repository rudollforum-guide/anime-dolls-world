...
export default function Home() {
  return <>
    ...
    <section className="section gallery-section" aria-labelledby="gallery-title"><div className="container"><div className="section-head"><div><p className="eyebrow">Визуальная коллекция</p><h2 id="gallery-title">Галерея образов</h2></div><p>Посмотрите модели разных брендов и перейдите к тем, которые заинтересовали.</p></div><ImageGallery /><div className="gallery-home-action"><Link className="button secondary" href="/gallery/">Смотреть всю галерею</Link></div></div></section>
