...
export default function Home() {
  return <>
    <section className="hero"><HeroMaidScene /><div className="container"><div className="hero-content"><p className="eyebrow">Независимый каталог · 18+</p><h1>Anime Dolls <span>World</span></h1><p className="lede">Каталог аниме- и фурри-кукол, брендов, магазинов и спокойных, проверяемых материалов по выбору и уходу.</p><div className="hero-actions"><Link className="button primary" href="/brands/">Смотреть бренды</Link><Link className="button secondary" href="/stores/">Где купить</Link><Link className="button secondary" href="/anime-dolls/">Аниме-куклы</Link><Link className="button secondary" href="/furry-dolls/">Фурри-куклы</Link></div><div className="trust-row"><span>Без откровенного контента</span><span>Данные из открытых источников</span><span>Не магазин</span></div></div></div></section>
    <section className="section"><div className="container"><div className="section-head"><div><p className="eyebrow">Навигация по миру кукол</p><h2>Начните с нужного направления</h2></div><p>Разделяем категории и справочные материалы, чтобы сравнивать бренды было проще.</p></div><div className="direction-grid"><CategoryHeroCard title="Аниме-куклы" description="Персонажи, эстетика и коллекции в аниме-стиле" href="/anime-dolls/" image="/images/sections/anime-section.webp" /><CategoryHeroCard title="Фурри-куклы" description="Фэнтезийные персонажи и необычные образы" href="/furry-dolls/" image="/images/sections/furry-section.webp" /><CategoryHeroCard title="Выбор и покупка" description="Руководства по выбору, заказу и доставке" href="/buying/" image="/images/sections/buying-section.webp" /></div></div></section>
