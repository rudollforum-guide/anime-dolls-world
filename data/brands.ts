...
export const brands: Brand[] = [
  ...
  { slug: "kiradols", name: "Kiradols", categories: ["anime"], website: "https://kiradols.com/", summary: "Производитель полноразмерных силиконовых моделей с выраженной аниме-стилистикой и персонажными 3D-скульптами.", ...placeholder },
