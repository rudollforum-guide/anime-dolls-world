...
const galleryModels: GalleryModel[] = [
  {
    name: "Tsumugi",
    details: "#KH003 — DLC006",
    folder: "150cm-tsumugi",
    ...
    characteristics: {
      ...
      weight: "29 кг",
      specs: [
        { label: "Вес тела без головы", value: "26 кг" },
        { label: "Грудь", value: "62 см" },
        { label: "Под грудью", value: "55 см" },
        { label: "Талия", value: "48 см" },
        { label: "Бёдра", value: "86 см" },
        { label: "Плечи", value: "30 см" },
        { label: "Нога", value: "86 см" },
        { label: "Рука", value: "43 см" },
  ...
  },
  {
    ...
    characteristics: {
      ...
      weight: "31 кг",
      specs: [
        { label: "Вес тела без головы", value: "28 кг" },
        { label: "Вес отправления", value: "39 кг" },
        { label: "Грудь", value: "72 см" },
        { label: "Под грудью", value: "55 см" },
        { label: "Талия", value: "50 см" },
        { label: "Бёдра", value: "89 см" },
        { label: "Плечи", value: "30 см" },
        { label: "Нога", value: "90 см" },
        { label: "Рука", value: "45 см" },
  ...
  },
  {
    ...
    characteristics: {
      ...
      specs: [
        ...
        { label: "Талия", value: "50 см" },
        { label: "Бёдра", value: "89 см" },
        { label: "Верхняя часть бёдер", value: "68 см" },
        { label: "Плечи", value: "30 см" },
        { label: "Длина ноги", value: "90 см" },
        { label: "Внутренняя длина ноги", value: "77 см" },
        { label: "Длина руки", value: "45 см" },
        { label: "Длина кисти", value: "14 см" },
        { label: "Стопа", value: "21 см" },
        { label: "Обхват шеи", value: "23 см" },
      ],
    },
  },
  {
    name: "Saori",
    details: "#KH005 — DLC002",
    folder: "155cm-saori",
    photos: ["01.png", "02.png", "03.png"],
    characteristics: {
      height: "155 см",
      ...
      weight: "30 кг",
      specs: [
        { label: "Вес тела без головы", value: "27 кг" },
  ...
  {
    name: "Umegawa Kurako",
    details: "#KH001 — DLC001",
    folder: "155cm-umegawa-kurako",
    photos: ["01.png", "02.png", "03.png"],
    characteristics: {
      height: "155 см",
      material: "силикон",
