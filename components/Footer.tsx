  ...
  return (
    <footer className="footer">
      <div className="container footer-grid">
        ...
        <div><h2>Каталог</h2><Link href="/brands/">Бренды</Link><Link href="/gallery/">Галерея образов</Link><Link href="/anime-dolls/">Аниме-куклы</Link><Link href="/furry-dolls/">Фурри-куклы</Link><Link href="/stores/">Магазины</Link><Link href="/stores/moon-doll/">Moon-Doll</Link></div>
