...
export function FurryDollsGuide() {
  ...
  return <>
    <PageHero eyebrow="Фурри-направление" title="Фурри-куклы" description="Антропоморфные, звериные и фантазийные персонажи с нестандартными головами, ушами, хвостами и другими декоративными элементами." crumbs={[{ label: "Фурри-куклы" }]} />
