...
export function BCDollProfile() {
  const webPageJsonLd = {
    ...
    "@type": "WebPage",
    name: "BC Doll — силиконовые аниме-куклы и мини-модели",
    description: "Информация о BC Doll: силиконовые аниме-куклы, мини- и полноразмерные модели, PU-головы, каркас, комплектация, официальный сайт и заказ.",
  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="bc-hero-grid">
            <div>
              ...
              <p className="lede">BC Doll — бренд аниме-кукол и коллекционных моделей, ориентированный преимущественно на силиконовые изделия с подвижным каркасом.</p>
      ...
      <article className="bc-profile">
        ...
        <section className="section"><div className="container"><div className="section-head"><div><p className="eyebrow">Варианты исполнения</p><h2>Материалы</h2></div><p>Материал головы и тела следует проверять в карточке выбранной модели.</p></div><div className="bc-material-grid"><section className="bc-material-card featured"><span className="tag">Основной материал</span><h3>Силикон</h3><p>Основной материал тел BC Doll — силикон. Производитель описывает его как мягкий и эластичный материал с детализированным окрашиванием поверхности.</p><p>Внутри используется подвижный металлический или сплавной каркас.</p></section><section className="bc-material-card"><span className="tag">Отдельные модели</span><h3>PU-головы</h3><p>У некоторых моделей голова изготавливается из PU, а тело — из силикона. Производитель указывает, что PU хорошо удерживает форму и макияж.</p><p>Особенности ухода необходимо проверять для конкретной модели.</p></section></div></div></section>
