...
const galleryModels: GalleryModel[] = [
  {
    ...
    characteristics: {
      height: "157 см",
      material: ["Голова — PVC", "Тело — силикон"],
      weight: "33 кг",
      specs: [
        { label: "Размер груди", value: "D Cup" },
        { label: "Верх груди", value: "66 см" },
        { label: "Под грудью", value: "54 см" },
        { label: "Талия", value: "51,5 см" },
        { label: "Бёдра", value: "85 см" },
        { label: "Плечи", value: "30 см" },
        { label: "Длина руки", value: "61 см" },
        { label: "Обхват руки", value: "19 см" },
        { label: "Запястье", value: "12,5 см" },
        { label: "Длина кисти", value: "16 см" },
        { label: "Внешняя длина ноги", value: "88 см" },
        { label: "Внутренняя длина ноги", value: "80 см" },
        { label: "Обхват бедра", value: "48 см" },
        { label: "Обхват голени", value: "32 см" },
        { label: "Стопа", value: "22,5 см" },
      ],
    },
  },
  {
